          ...
          <div className="space-y-6 text-gray-700">
            ...
            <section>
              ...
              <p>
                ...
                and include applicable taxes. Payment is processed securely through Razorpay.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Please contact us if you have any issues with your order. We handle returns and refunds
            ...
            <section>
              ...
              <p>
                ...
                <a href="mailto:support@thestoree.in" className="text-primary-600 hover:underline">
